...
public class GroupDetailsAdapter extends ArrayAdapter<LLS.LLSNode> {
    private static final String TAG = "ProcessingListAdapter";

    private Context mContext;
    private int mResource;
    private int lastPosition = -1;

    public static class GroupDetailsListViewHolder {
    ...
    public GroupDetailsAdapter(@NonNull Context context, int resource, @NonNull List<LLS.LLSNode> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        //ViewHolder object
        GroupDetailsListViewHolder  holder;


        if(convertView == null){
            LayoutInflater inflater = LayoutInflater.from(mContext);
            convertView = inflater.inflate(mResource, parent, false);
            holder= new GroupDetailsListViewHolder();
            ...
            holder = (GroupDetailsListViewHolder) convertView.getTag();
            result = convertView;
        }
