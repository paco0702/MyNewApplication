...
public class ProcessingListAdapter extends ArrayAdapter<LLS> {
    ...
    public ProcessingListAdapter(@NonNull Context context, int resource, @NonNull List<LLS> objects, ArrayList<String> eventKeyList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        holder.groupInformation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FLAT_FOR_GroupDetail = "Processing";
